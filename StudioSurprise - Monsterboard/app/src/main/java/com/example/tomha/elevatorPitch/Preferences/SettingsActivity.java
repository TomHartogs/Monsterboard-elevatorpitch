...
import com.example.tomha.elevatorPitch.R;
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                switch(preference.getKey()){
                    ...
                    case "maxRecordingLengthEnabled":
                        preference.getPreferenceManager().findPreference("maxRecordingLength").setEnabled((boolean) value);
                        preference.getPreferenceManager().findPreference("countdownTimerEnabled").setEnabled((boolean) value);
                        break;
                }
            } else {
